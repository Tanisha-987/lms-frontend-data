...
//       <form className="bg-white h-[640px] shadow pt-[40px]  p-[60px] rounded-md  ">
...
//               <input className="w-4 h-4" type="radio" name="role" value="student" /> Student
//             </label>
//             <label className="text-lg">
//               <input className="w-4 h-4" type="radio" name="role" value="Instructor" /> Instructor
//             </label>
//           </div>
//         </div>
...
//           Sign Up
//         </button>
//         <h2 className="text-gray-500 pt-4 text-center text-xl ">Already have an account ? 
//           <Link to="/login"> <span className="text-blue-500 font-semibold hover:underline">Log in</span></Link></h2>
